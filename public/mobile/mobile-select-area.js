        ...
        f: function (data) {
            ...
            if (_this.index !== 0 && _this.value[_this.index - 1] == "0" && this.default == 0) {
                ...
                if (item.length > 0 && this.default == 1) {
                    ...
                    } /*else if (this.settings.value && this.settings.value.split(',').toString() === _this.value.toString()) {
                        if (addressData[_this.value[this.index]]) {
                            _this.text[this.index] = addressData[_this.value[this.index]][0];
                        } else {
                            for (var i in _this.data) {
                                if (_this.value[this.index] === _this.data[i].id) {
                                    _this.text[this.index] = _this.data[i].name;
                                }
                            }
                        }
                    }*/
