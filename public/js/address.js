!function ($) {
    ...
    var address = {
        setObject: function (name, obj, val) {
            var obj = $(obj).first();
            if (obj.length) {
                this[name] = obj;
                this[name + 'Val'] = val;
                this['update' + name.capitalize() + 'Source']();
            }
            return obj;
        },
        // 设置省份
        setProviceObject: function (obj, val) {
            ...
            if (oldObj.length) {
                oldObj.off('change', '', this.updateCitySource);
            }
        ...
        setCityObject: function (obj, val) {
            ...
            if (oldObj.length) {
                oldObj.off('change', '', this.updateDistrictSource);
            }
        ...
        // 更新数据
        updateSource: function (obj, pid, selected, prefix) {
            if (!$(obj).length) {
                return;
            }
        ...
        updateProvinceSource: function () {
            ...
            this.updateSource(obj, 1, this['provinceVal'], '<option value="" selected="selected">请选择省市/其他...</option>');
    ...
    $.fn.extend({
        ...
        district: function (id) {
            ...
            (id === undefined) && (id = obj.data('id'));
            address.setDistrictObject(obj, id);
