...
class MyGoodsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('child-user.my-goods.index', [
            'goods' => $myGoods,
    ...
    public function create()
    {
        ...
        return view('child-user.my-goods.goods', [
            'goods' => $goods,
            'attrs' => [],
            'type' => $user->type
        ]);
    ...
    {
        return view('child-user.my-goods.batch-create');
    }
    ...
    {
        $user = child_auth()->user();
        if (Gate::forUser($user)->denies('validate-my-goods', $goods)) {
            return redirect(url('child-user/my-goods'));
        }
        ...
        return view('child-user.my-goods.detail', [
            'goods' => $goods,
            'attrs' => $attrs,
            'isLike' => $isLike,
