    ...
    <form class="form-horizontal" method="get" action="{{ url('admin/trade') }}">
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-10">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ url('admin/trade/export-to-excel?' . $linkUrl) }}" class="btn btn-bg btn-warning">导出</a>
            </div>
        </div>
