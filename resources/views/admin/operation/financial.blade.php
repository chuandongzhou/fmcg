...
@section('right-container')
    ...
    <div class="content-wrap">
        <form class="form-horizontal" action="{{ url('admin/operation-data/financial') }}" method="get"
              autocomplete="off">
            <a href="{{ url('admin/operation-data/financial?t=today') }}" class="time-format">今天</a>
            <a href="{{ url('admin/operation-data/financial?t=yesterday') }}" class="time-format">昨天</a>
            <a href="{{ url('admin/operation-data/financial?t=week') }}" class="time-format">本周</a>
            <a href="{{ url('admin/operation-data/financial?t=month') }}" class="time-format">本月</a>
