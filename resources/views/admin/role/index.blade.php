...
@section('right-container')
    <form class="form-horizontal ajax-form" method="post" action="{{url('admin/role')}}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-xs" role="group">
                            ...
                            <a class="btn btn-primary" href="{{url('admin/role/'.$key.'/edit')}}"><i
                                        class="fa fa-edit"></i> 修改</a>
                            <a class="btn btn-danger ajax" data-method="delete" data-url="{{url('admin/role/' . $key)}}"><i
