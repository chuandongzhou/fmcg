...
@section('container')
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <form class="form-horizontal" data-done-then="refresh" action="{{ url('child-user/business-order/order-forms') }}"
                ...
                <div class="row delivery">
                    <div class="col-sm-12 control-search">
                        <form action="" method="get" autocomplete="off">
                            ...
                            <button type="submit" data-url="{{ url('child-user/business-order/order-forms') }}"
                    ...
                    <div class="col-sm-12 table-responsive table-wrap">
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="color-blue"
                                           href="{{ $order->order_id ?  url('child-user/order/' . $order->order_id)  :url('child-user/business-order/' . $order->id) }}">
                                        ...
                                        @else
                                            <a class=""
                                               href="{{ url('child-user/business-order/export?order_id[]=' . $order->id) }}">
                        ...
                        <div class="business-operating">
                            ...
                            <button class="btn btn-blue batch btn-submit" type="submit"
                                    data-url="{{ url('child-user/business-order/export') }}">
                                批量导出
                            </button>
                        </div>
