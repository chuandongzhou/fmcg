        ...
        <div class="row">
            ...
            <div class="col-sm-4 store-detail-wrap pd-left-clear">
                ...
                <div class="item">
                    ...
                    <div class="pull-right collect-item {{ $isMyGoods ? '' : 'btn-like' }} like-goods"
                         ...
                         data-id="{{ $goods->id }}"
                         style="cursor:{{ $isMyGoods ? 'auto' : 'pointer' }}">
            ...
            <div class="col-sm-3 shop-detail-wrap">
                ...
                <div class="operate">
                    ...
                    @else
                        <a href="javascript:"
                           onclick="window.open('{{ url('child-user/chat/kit?remote_uid=' .$shop->id) }}&fullscreen', 'webcall',  'toolbar=no,title=no,status=no,scrollbars=0,resizable=0,menubar＝0,location=0,width=700,height=500');"
            ...
            <div class="col-sm-2 hot-goods-panel">
                ...
                @foreach($hotGoods as $good)
                    <div class="commodity commodity-border">
                        <div class="img-wrap">
                            <a href="{{ url('child-user/my-goods/' . $good->id) }}" target="_blank">
                        ...
                        <div class="content-panel">
                            <p class="commodity-name">
                                <a href="{{ url('child-user/my-goods/' . $good->id) }}"
