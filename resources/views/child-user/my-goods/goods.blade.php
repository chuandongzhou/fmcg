                            ...
                            <div class="col-sm-12 ">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><span class="red">*</span> <b>单位设置</b> <span
                                                    class="prompt">至少设置一级单位</span>
                                        </h3>
                                    </div>
                ...
                <div class="row goods-editor goods-editor-second hide">
                    ...
                    <div class="col-sm-12 ">
                        ...
                        <div class="row editor-panel content-wrap">
                            ...
                            @if($type == cons('user.type.supplier') or $type == cons('user.type.maker'))
                                <div class="col-sm-12 ">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                        ...
                                        <div class="panel-container">
                                            ...
                                            <div class="form-group editor-item">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="price_wholesaler_pick_up"
                                                           class="form-control"
                                                           value="{{ $goods->price_wholesaler_pick_up }}"
                                                           placeholder="请输自提价"/>
                                                </div>
                                                <div class="col-sm-1 pieces padding-clear">元/<span
                                                            class="pieces_wholesaler">
