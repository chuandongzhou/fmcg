        ...
        <div class="page-content">
            <div class="row">
                <div class="col-sm-12 path-title">
                    ...
                    ><span class="second-level"> 个人中心</span>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-container clearfix">
                                ...
                                <div class="store-panel clearfix">
                                    ...
                                    <div class="store-msg">
                                        <div class="store-name">
                                            <div class="item"><span class="panel-name">店铺名称 : </span>{{ $shop->name }}
                                            </div>
                            ...
                            <div class="col-xs-1 text-left padding-clear">
                                <a class="btn editor-btn" href="{{ url('child-user/shop') }}"><i
                                            class="iconfont icon-xiugai"></i>
                                    编辑</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row home-orders-list">
                <div class="col-xs-3 item">
                    <div class="item-wrap">
                        ...
                        <a href="{{ url('child-user/order?status=non_confirm') }}">
                            <div class="check-btn">
                                查看订单
                ...
                <div class="col-xs-3 item">
                    <div class="item-wrap">
                        ...
                        <a href="{{ url('child-user/order?status=non_send') }}">
                            <div class="check-btn">
                                查看订单
                                <i class="iconfont icon-youjiantou"></i>
                            </div>
                ...
                <div class="col-xs-3 item">
                    <div class="item-wrap">
                        ...
                        <a href="{{ url('child-user/order?status=non_payment') }}">
                            <div class="check-btn">
                                查看订单
                                <i class="iconfont icon-youjiantou"></i>
                            </div>
                ...
                <div class="col-xs-3 item">
                    <div class="item-wrap">
                        ...
                        <a href="{{ url('child-user/order/wait-receive') }}">
                            <div class="check-btn">
                                查看订单
                                <i class="iconfont icon-youjiantou"></i>
                            </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            function countData(month) {
                $.ajax({
                    url: site.api('child-user/shop/order-data?month=')+ month,
                    method: 'get'
                }).done(function (data) {
                    //完成订单信息
