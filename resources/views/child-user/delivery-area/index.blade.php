        ...
        <div class="page-content">
            <div class="row">
                <div class="col-sm-12 path-title">
                    <a href="{{ url('child-user/delivery-area') }}">个人中心</a> ><span class="second-level"> 配送区域</span>
                </div>
            </div>
                    ...
                    <div class="col-sm-12 table-responsive">
                        <div class="delivery-area-wrap">
                            <a class="personal-add update-modal " data-target="#addressModal"
                               data-toggle="modal" data-url="{{ url('api/v1/child-user/delivery-area') }}"
                                        ...
                                        <td>
                                            ...
                                            <div role="group" class="btn-group btn-group-xs">
                                                <a data-target="#addressModal" data-toggle="modal"
                                                   ...
                                                   data-url="{{ url('api/v1/child-user/delivery-area/' .$area->id ) }}"
                                                   class="edit update-modal">
                                                    <i class="iconfont icon-xiugai"></i> 编辑
                                                </a>
                                                <a data-url="{{ url('api/v1/child-user/delivery-area/'. $area->id) }}"
