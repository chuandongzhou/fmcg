                        ...
                        @foreach(cons()->valueLang('order.templete') as $templeteId => $templeteName)
                            <div class="col-sm-4 item">
                                ...
                                <div class="choice-item">
                                    <label>
                                        <input data-url="{{ url('api/v1/child-user/order/templete/' . $templeteId)  }}"
                                               data-method="post"
                                ...
                                <div class="panel">
                                    <p>{{ $tempHeader->name }}
                                        ...
                                        <a class="pull-right red ajax operate"
                                           data-url="{{ url('api/v1/child-user/templete/'.$tempHeader->id) }}"
                                    ...
                                    <p class="clearfix account-number">
                                        ...
                                        @else
                                            <a class="pull-right ajax"
                                               data-url="{{ url('api/v1/child-user/templete/default/'.$tempHeader->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body address-select">
                    <form class="form-horizontal ajax-form" action="{{ url('api/v1/child-user/templete') }}"
