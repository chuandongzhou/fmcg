        ...
        <div class="page-content">
            <div class="row">
                <div class="col-sm-12 path-title">
                    @if(request()->is('child-user/customer/wholesaler'))
                        <a href="{{ url('child-user/customer/retailer') }}">客户管理</a> >
            ...
            <div class="row delivery">
                <div class="col-sm-12 control-search">
                    <form method="get" action="{{ url('child-user/customer/'. $type) }}" class="form-horizontal"
                          autocomplete="off">
