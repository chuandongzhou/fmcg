        ...
        <div class="page-content">
            <div class="row">
                <div class="col-sm-12 path-title">
                    <a href="{{ url('child-user/delivery-man') }}">配送管理</a> >
                    ...
                    <div class="col-sm-12 table-responsive">
                        <div class="add-coupon">
                            <a class="add btn btn-blue-lighter update-modal" href="javascript:" data-toggle="modal"
                               data-target="#deliveryModal" data-url="{{ url('api/v1/child-user/delivery-man') }}">
                                <label>
                                    ...
                                    <td>
                                        ...
                                        <div role="group" class="btn-group btn-group-xs">
                                            <a data-toggle="modal"
                                               ...
                                               data-url="{{ url('api/v1/child-user/delivery-man/' . $man->id) }}"
                                            ...
                                            @endif
                                            <a data-url="{{ url('api/v1/child-user/delivery-man/'. $man->id) }}"
