...
@include('includes.child-salesman')
...
@section('container')
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <form action="{{ url('child-user/salesman') }}" method="get">
                <div class="row salesman">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div role="group" class="btn-group btn-group-xs">
                                            ...
                                            <a class="color-blue" href="{{ url('child-user/report/' . $man->id) }}">
                                                <i class="iconfont icon-jingzhibaogao"></i> 报告&nbsp;</a>
                                            @if($man->status==cons('status.off'))
                                                <a class="ajax gray-light"
                                                   data-url="{{ url('api/v1/child-user/salesman/lock') }}"
                    ...
                    <div class="col-sm-12 form-group remove-panel">
                        ...
                        <a data-url="{{ url('api/v1/child-user/salesman/batch-delete') }}" data-method="delete"
