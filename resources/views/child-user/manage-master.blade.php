@extends('master')
@include('includes.chat', ['shopId' => child_auth()->user()->shop_id])
...
@section('header')
    ...
    <div class="page-header navbar navbar-fixed-top">
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                <span class="link-index logo-default">订百达管理</span>
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="{{ child_auth()->user()->first_node->url }}" class="dropdown-toggle"
                               data-hover="dropdown"
                               data-close-others="true">
                                <img alt="" class="img-circle"
                                     src="{{ $logUrl = child_auth()->user()->shop->logo_url }}"/>
                                <span class="username username-hide-on-mobile">{{ $shopName = child_auth()->user()->shop->name }}</span>
                            </a>
                        </li>
                        <!--退出登录-->
                        <li class="dropdown dropdown-extended drop-exit ">
                            <a href="{{ url('child-user/auth/logout') }}">
