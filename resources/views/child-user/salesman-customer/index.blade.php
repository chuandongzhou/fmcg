    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="row salesman">
                <form class="form-horizontal" method="get" action="{{ url('child-user/salesman-customer') }}"
                      autocomplete="off">
                    <div class="col-sm-12 form-group salesman-controls">
                        <a class="btn btn-blue-lighter" href="{{ url('child-user/salesman-customer/create') }}"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div role="group" class="btn-group btn-group-xs">
                                            <a class=" edit"
                                               href="{{ url('child-user/salesman-customer/' . $customer->id . '/edit') }}">
                                                <i class="iconfont icon-xiugai"></i> 编辑
                                            </a><a class="edit"
                                                   href="{{ url('child-user/salesman-customer/' . $customer->id) }}">
    ...
    <script type="text/javascript">
        ...
        var customerMapData = function () {
            ...
            $('.salesman-customer-table  .map-data').each(function () {
                ...
                data['href'] = site.url('child-user/salesman-customer/' + obj.data('id'));
                mapData.push(data);
            });
            return mapData;
        };
