        ...
        <div class="page-content">
            ...
            <div class="row sales-details-panel">
                <div class="col-sm-12 form-group salesman-controls">
                    <form action="{{ url('child-user/salesman-customer/' . $customer->id) }}">
                        ...
                        <a id="export"
                           href="{{ url('child-user/salesman-customer/' . $customer->id .'/export?begin_time=' . $beginTime . '&end_time=' . $endTime) }}"
