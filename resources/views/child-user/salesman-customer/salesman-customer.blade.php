...
@include('includes.customer-mortgage-goods',['url' => url('api/v1/child-user/mortgage-goods')])
            ...
            <div class="row salesman">
                <div class="col-sm-12 create">
                    <form class="form-horizontal ajax-form"
                          action="{{ url('api/v1/child-user/salesman-customer/' . $salesmanCustomer->id) }}"
                          method="{{ $salesmanCustomer->id ? 'put' : 'post' }}"
                          data-help-class="col-sm-push-2 col-sm-10"
                          data-done-url="{{ url('child-user/salesman-customer') }}" autocomplete="off">
                        ...
                        @if(($userType = child_auth()->user()->type) == cons('user.type.supplier'))
                            <div class="form-group row">
