...
@section('container')
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <form action="{{ url('child-user/report') }}" method="get">
                <div class="row salesman">
                    <div class="col-sm-12 form-group salesman-controls">
                        <form action="">
                            ...
                            <a id="export"
                               href="{{ url('child-user/report/export?start_date=' . $startDate . '&end_date=' . $endDate) }}"
                        ...
                        <table class="table table-bordered table-center table-middle public-table">
                            ...
                            @foreach($salesmen as $man)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('child-user/report/' . $man->id . "?start_date={$startDate}&end_date={$endDate}") }}"
