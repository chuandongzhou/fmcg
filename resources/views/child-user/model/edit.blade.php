...
@include('includes.my-goods', ['getGoodsUrl' => url('api/v1/child-user/model/goods-page'), 'setAdvertUrl' => url('api/v1/child-user/model/recommend-goods')])
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-sm-12 path-title">
                    <a href="{{ url('child-user/model/model-edit') }}">模版管理</a> >
            ...
            <div class="row choice-template margin-clear">
                <div class="col-sm-12 ">
                    ...
                    <div class="row template-item">
                        ...
                        <div class="col-sm-12 item-wrap">
                            <form class="form-horizontal ajax-form"
                                  action="{{ url('api/v1/child-user/model/shop-advert') }}"
                                  method="post"
                                  data-help-class="col-sm-push-2 col-sm-10"
                                  data-done-url="{{ url('child-user/model/model-edit') }}"
                                  autocomplete="off">
                    ...
                    <div class="row template-item">
                        ...
                        <div class="col-sm-12 recommend">
                            <a href="javascript:" class="btn my-goods" data-target="#myModal" data-toggle="modal">选择文件</a>
                            <span class="prompt ">已选商品<span
                                >{{ $shop->shopRecommendGoods->count() }}</span>个</span>
                        </div>
                    </div>
                </div>
