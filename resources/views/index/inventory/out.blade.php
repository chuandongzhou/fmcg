    ...
    <div class="row delivery">
        <div class="col-sm-12 control-search">
            <form action="" method="get" autocomplete="off">
                ...
                <input class="enter control" name="number" placeholder="出库单号/售货单号" type="text" value="{{$data['number'] ?? ''}}">
                ...
                <div class="warehousing-error-btn red">出库异常<a href="{{ url('inventory/out-error') }}" class="badge badge-danger" >9</a></div>
            </form>
        </div>
                ...
                @if(isset($lists))
                    @foreach($lists as $list)
                        <tr>
                            ...
                            <td><a class="edit" href="{{url('inventory/out-detail')}}/{{$list->inventory_number}}">查看</a>
                            </td>
                        </tr>
                    @endforeach
                @endif
