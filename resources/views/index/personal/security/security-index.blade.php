            ...
            <div class="row margin-clear">
                <div class="col-sm-12 security-setting-wrap">
                    ...
                    <div class="item">
                        ...
                        <a href="{{ url('personal/security/validate-phone?type=backup-phone') }}"><span class="edit"><i
                                        class="iconfont icon-xiugai"></i>修改</span></a>
                    </div>
                    <div class="item">
                        密码 <span class="prompt">(用于登录和修改密码使用，请妥善保管)</span>
                        <a data-target="#passwordModal" data-toggle="modal"><span class="edit"><i
                                        class="iconfont icon-xiugai"></i>修改</span></a>
                    </div>
                </div>
            </div>
