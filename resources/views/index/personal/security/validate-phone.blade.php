...
@section('right')
    <div class="row margin-clear">
        <div class="col-sm-12 security-setting-wrap">
            <form class="form-horizontal ajax-form" action="{{ url('api/v1/personal/security/validate-backup-sms') }}"
                  method="post" data-done-url="{{ $type=='password'?url('personal/security/password'):url('personal/security/backup-phone') }}">
