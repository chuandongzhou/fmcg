        ...
        <form class="form-horizontal ajax-form" method="put"
            ...
            <div class="col-sm-9 user-show">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <select name="province_id" data-id="{{ $shop->province_id }}" class="address-province form-control">
                            <option selected="selected" value="">请选择省市/其他...</option>
                            <option value="210000">辽宁省</option>
                        </select>
                    </div>
                    <div class="col-sm-3">
                        <select name="city_id" data-id="{{ $shop->city_id }}" class="address-city form-control">
                            <option selected="selected" value="">请选择城市...</option>
                        </select>
                    </div>
                    <div class="col-sm-4">
                        <select name="district_id" data-id="{{ $shop->district_id }}" class="address-district form-control">
                            <option selected="selected" value="">请选择区/县...</option>
                        </select>
                    </div>
                    <div class="col-sm-4">
                        <select name="street_id"  data-id="{{ $shop->street_id }}"  class="address-street form-control"></select>
                    </div>
                </div>
