                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="edit update-shipping-address"
                                                   ...
                                                   data-consigner="{{ $defaultAddress['consigner'] }}"
                                                   ...
                                                   data-x-lng="{{ $defaultAddress['x_lng'] }}"
                                                   data-y-lat="{{ $defaultAddress['y_lat'] }}"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="edit update-shipping-address"
                                                   ...
                                                   data-toggle="modal"
                                                   data-id="{{ $address['id'] }}"
                                                   data-consigner="{{ $address['consigner'] }}"
                                                   ...
                                                   data-x-lng="{{ $address['x_lng'] }}"
                                                   data-y-lat="{{ $address['y_lat'] }}"><i
                                                            class="iconfont icon-xiugai"></i> 编辑</a>
                                                <a class="ajax red"
