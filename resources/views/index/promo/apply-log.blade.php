        ...
        <div class="page-content">
            ...
            <div class="row delivery">
                <div class="col-sm-12 control-search assets">
                    <form action="{{ url('promo/apply-log') }}" method="get" autocomplete="off">
                        <input class="enter control datetimepicker" data-format="YYYY-MM-DD" name="start_at" placeholder="开始时间" type="text"
                               value="{{$data['start_at'] or ''}}">至
                        <input class="enter control datetimepicker" data-format="YYYY-MM-DD" name="end_at" placeholder="结束时间" type="text"
                                ...
                                <td width="17%">
                                    ...
                                    <a href="javascript:"
                                       ...
                                       data-url="{{url('api/v1/promo/apply/pass/'.$apply->id)}}">
                                        <i class="iconfont icon-qiyong"></i>通过</a>
                                    <a href="javascript:"
                ...
                <div class="col-sm-12 text-right">
                    {!! $promoApply->appends($data)->render() !!}
                </div>
            </div>
        </div>
    </div>
