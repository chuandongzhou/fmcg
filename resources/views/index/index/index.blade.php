                ...
                <div class="row list-penal">
                    ...
                    <div class="col-xs-12 padding-clear">
                            ...
                            <div class="padding-clear left-menu-wrap pull-left">
                                @if(!$column->leftAdverts->isEmpty())

                                <a href="{{ $column->leftAdverts[0]->url }}"><img class="commodity-img lazy" data-original="{{ $column->leftAdverts[0]->image_url }}"></a>
                                    ...
                                    @if(!$column->adverts->isEmpty())
                                        ...
                                        <ul class="carousel-indicators carousel-indicators-item">
                                            @foreach($column->adverts as $key=>$image)
                                                <li class="{{ $key == 0 ? 'active' : '' }}" data-target="#myCarousel{{ $index }}"
                                                    data-slide-to="{{ $key }}">
