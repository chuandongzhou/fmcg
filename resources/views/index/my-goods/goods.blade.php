                ...
                <div class="row editor-panel content-wrap">
                    <div class="col-sm-12 editor-wrap">
                        ...
                        <div class="form-group editor-item">
                            ...
                            <div class="col-sm-2">
                                <input name="price_retailer_pick_up" value="{{ $goods->price_retailer_pick_up }}"
                                       placeholder="请输入自提价格"
                                       type="text" class="form-control">
                            </div>
                        ...
                        <div class="form-group editor-item">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="{{ $goods->min_num_retailer }}"
                                       name="min_num_retailer"
                        ...
                        @if (auth()->user()->type == cons('user.type.supplier'))
                            ...
                            <div class="form-group editor-item">
                                ...
                                <div class="col-sm-6">
                                    <input name="specification_wholesaler"
