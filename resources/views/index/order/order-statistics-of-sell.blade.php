        ...
        <div class="page-content">
            ...
            <div class="row my-goods order-report margin-clear">
                <div class="col-sm-12 content">
                    <form action="{{ url('order/statistics-of-sell') }}" method="get" autocomplete="off">
                        <div class="col-sm-12 enter-item">
                            ...
                            <a id="export"
                               href="{{ url('order/statistics-of-sell-export?' . http_build_query($data)) }}"
                    ...
                    <div class="col-sm-12 tables">
                        ...
                        <table class="MyTable1 table-scroll">
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($ownOrdersStatisticsTargetFee = $ownOrdersStatistics['targetFee'], 2) }}</td>
                        ...
                        <table class="MyTable2 table-scroll">
                            <thead>
                            <tr>
                                <td class="first-td text-right">客户名称</td>
                                <td class="2-1">
                                    订单数
                                    <p class="margin-clear prompt">( @if(auth()->user()->type < cons('user.type.maker'))
                                            业务订单+@endif自主订单)</p>
                                </td>
                                <td>
                                    总金额
