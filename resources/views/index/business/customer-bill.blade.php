            ...
            <div class="row delivery">
                <div class="col-sm-12 control-search assets">
                    <form action="" method="get" autocomplete="off">
                        ...
                        <a href="{{url('business/salesman-customer/'.$bill['customer']->id.'/bill?time='.($data['time'] ?? '').'&act=export')}}" class=" btn btn-border-blue control ">打印</a>
                    </form>
                </div>
                    ...
                    <div class="col-sm-12 statement-item">
                        ...
                        <div class="row list-wrap">
                            ...
                            <div class="col-sm-7 item-col">
                                <label>对账时间 : {{$bill['time']['start_at']->toDateString()}} — {{$bill['time']['end_at']->toDateString()}}</label>
                            </div>
                            ...
                            <table class="table table-bordered table-center ">
                                ...
                                <tr>
                                    <td colspan="6" class="text-right">
                                        <div class="money-item"><label>总计金额：</label>{{sprintf("%.2f",$bill['allOrders']->sum('price'))}}</div>
                                        <div class="money-item"><label>优惠总额：</label>{{sprintf("%.2f",$bill['allOrders']->sum('how_much_discount'))}}</div>
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-container table-responsive padding-clear">
                            <table class="table table-bordered table-center ">
                                ...
                                <tr>
                                    <td colspan="6" class="text-right">
                                        <div class="money-item"><label>总计收支金额：</label> {{number_format($bill['paymentDetails']->sum('amount'),2)}}</div>
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
