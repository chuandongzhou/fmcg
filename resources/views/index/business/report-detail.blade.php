                    ...
                    <table class="public-table MyTable1 table-scroll business-table">
                        ...
                        @foreach( $visitList as $key=>$visit)
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:window.open ('{{ url("business/report/2/customer-detail?start_date={$startDate}&end_date={$endDate}&customer_id={$visit['id']}") }}', 'newwindow', 'height=600, width=1000')">明细</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
