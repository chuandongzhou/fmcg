                ...
                <table class="table table-bordered table-center table-middle public-table">
                    ...
                    @foreach($salesmen as $man)
                        <tr>
                            ...
                            <td>
                                <b class="red">{{ $man->orderFormCount }}</b> ({{ $man->visitOrderFormCount . '+' . bcsub($man->orderFormCount, $man->visitOrderFormCount) }})
                            </td>
                            <td>
                                <b class="red">{{ $man->orderFormSumAmount }}</b> ({{ $man->visitOrderFormSumAmount . '+' . ($man->orderFormSumAmount - $man->visitOrderFormSumAmount) }})
                            </td>
