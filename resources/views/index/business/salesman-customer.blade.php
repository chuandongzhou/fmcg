...
@section('right')
    <form class="form-horizontal ajax-form"
            ...
            <label class="col-sm-2 control-label" for="contact"><span class="red">*</span>联系人:</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <input class="form-control" id="contact_information" name="contact_information"
                               placeholder="联系方式" value="{{ $salesmanCustomer->contact_information }}" type="text">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 control-label" for="business_area"><span class="red">*</span> 营业面积:</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <input type="text" placeholder="请输入详细地址" name="business_address[address]" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6 col-md-4">
                <input type="text" placeholder="请输入详细地址" name="shipping_address[address]" class="form-control"
        ...
        <div class="form-group display-goods mortgage-goods visible-item visible-item-2 {{ $salesmanCustomer->display_type == cons('salesman.customer.display_type.mortgage') ? '' : 'hidden' }}">
            ...
            <div class="col-sm-6 col-md-4 ">
                <button class="btn padding-clear" type="button" data-target="#mortgageGoodsModal" data-toggle="modal">设置商品</button>
                已选商品数<span class="red mortgage-goods-num">{{ count($salesmanCustomer->mortgageGoods) }}</span>个

                <div class="mortgage-goods-group hidden">
                    @foreach($salesmanCustomer->mortgageGoods as $mortgageGoods)
                        <input type="hidden" data-id="{{ $mortgageGoods->id }}" name="{{ 'mortgage_goods['. $mortgageGoods->id.']' }}" value="{{ (int)$mortgageGoods->pivot->total }}" />
                    @endforeach
