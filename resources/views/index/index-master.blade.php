                ...
                <div class="col-sm-8">
                    ...
                    <div class="navbar-collapse collapse top-nav-list" id="bs-example-navbar-collapse-9"
                        ...
                        <ul class="nav navbar-nav navbar-right operating-wrap">
                            ...
                            <li>
                                {{--TODO:判断用户类型--}}
                                @if(2 == cons('user.type.retailer'))
                                <a href="{{ url('order-buy') }}"><span class="fa fa-file-text-o"></span> 我的订单</a>
                                @else
                                    <a href="{{ url('order-sell') }}"><span class="fa fa-file-text-o"></span> 我的订单</a>
                                @endif
                            </li>
