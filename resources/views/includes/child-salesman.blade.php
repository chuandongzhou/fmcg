        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal ajax-form"
                      ...
                      data-done-url="{{ url('child-user/salesman') }}" data-no-loading="true" autocomplete="off">
                    ...
                    <div class="modal-footer middle-footer">
                        <button class="btn btn-success pull-right" data-method="post"
                                data-url="{{ url('api/v1/child-user/salesman' ) }}" type="submit">提交
                        </button>
                    </div>
                </form>
            </div>
        ...
        $(function () {
            ...
            salesmanModel.on('show.bs.modal', function (e) {
                ...
                if (salesmanId) {
                    ...
                    $.get(site.api('child-user/salesman/' + salesmanId), '', function (data) {
                        ...
                        submitBtn.data('method', 'put').data('url', site.api('child-user/salesman/') + salesmanId);
                    }, 'json')
                ...
                submitBtn.data('method', 'post').data('url', '{{ url('api/v1/child-user/salesman' ) }}');
                avatar.remove();
