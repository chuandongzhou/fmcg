<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false"
            ...
            {{--个人中心--}}
            <li class="nav-item start {!! path_active(['personal/shop','personal/security/*','personal/delivery-area*','personal/shipping-address*','personal/info', 'personal/child-user']) !!}">
                ...
                <ul class="sub-menu">
                    ...
                    @endif
                    @if ($user->type != cons('user.type.retailer'))
                        <li class="nav-item start {{ path_active('personal/child-user') }}">
                            <a href="{{ url('personal/child-user') }}" class="nav-link ">
            ...
            {{-- 库存管理 --}}
            @if($user->type > cons('user.type.retailer'))
                <li class="nav-item  {!!  request()->is('inventory','inventory/*', 'warehouse-keeper') ? 'active' : '' !!}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="iconfont icon-kucun"></i>
                        <span class="title">库存管理</span>
                        <span class="{!!  request()->is( 'inventory','inventory/*', 'warehouse-keeper')  ? 'selected' : '' !!}"></span>
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item  {{ request()->is('warehouse-keeper')? 'active' : '' }}">
                            <a href="{{ url('warehouse-keeper') }}" class="nav-link ">
            ...
            @if($user->type == cons('user.type.maker'))
                ...
                <li class="nav-item {!! path_active(['personal/deliver*','personal/delivery-truck*','personal/dispatch-truck*']) !!}">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item start {{ path_active(['personal/dispatch-truck']) }}">
                            <a href="{{ url('personal/dispatch-truck') }}" class="nav-link ">
                                <span class="title">发车单</span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    @if( true || $user->deposit && !$user->is_expire)
                        ...
                        <li class="nav-item  {!! path_active(['business/*']) !!}">
                            ...
                            <ul class="sub-menu">
                                ...
                                @if($user->type == check_role('supplier'))
